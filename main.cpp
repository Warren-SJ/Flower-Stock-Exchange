            ...
            while (!acc.getSellEntries().empty() && quantity > 0) { // If the top sell entry is less than or equal to the new price
                ...
                if (price >= acc.getSellEntries().front().getPrice()){
                    ...
                    if (acc.getSellEntries().front().getQuantity() > quantity){
                        ...
                        out << "Ord" << acc.getSellEntries().front().getOrderID() << ", " << acc.getSellEntries().front().getClientOrderID() << ", " << instrument << ", " << 2 << ", " << "PFill" << ", " << quantity << ", " << new_price << endl;
                        ...
                        out << "Ord" << order_number << ", " << client_order_id << ", " << instrument << ", " << side << ", " << "Fill" << ", " << quantity << ", " << new_price << endl;
                        out << "Ord" << acc.getSellEntries().front().getOrderID() << ", " << acc.getSellEntries().front().getClientOrderID() << ", " << instrument << ", " << 2 << ", " << "Fill" << ", " << quantity << ", " << new_price << endl;
                        acc.popFrontSellEntries();
                        quantity = 0;
                    }
                    else{
                        out << "Ord" << order_number << ", " << client_order_id << ", " << instrument << ", " << side << ", " << "PFill" << ", " << acc.getSellEntries().front().getQuantity() << ", " << new_price << endl;
                        out << "Ord" << acc.getSellEntries().front().getOrderID() << ", " << acc.getSellEntries().front().getClientOrderID() << ", " << instrument << ", " << 2 << ", " << "Fill" << ", " << acc.getSellEntries().front().getQuantity()<< ", " << new_price << endl;
            ...
            while (!acc.getBuyEntries().empty() && quantity > 0) { // If the top sell entry is less than or equal to the new price
                ...
                if (price <= acc.getBuyEntries().front().getPrice()) {
                    ...
                    if (acc.getBuyEntries().front().getQuantity() > quantity){
                        out << "Ord" << order_number << ", " << client_order_id << ", " << instrument << ", " << side << ", " << "Fill" << ", " << acc.getBuyEntries().front().getQuantity() - quantity << ", " << new_price << endl;
                        out << "Ord" << acc.getBuyEntries().front().getOrderID() << ", " << acc.getBuyEntries().front().getClientOrderID() << ", " << instrument << ", " << 1 << ", " << "Fill" << ", " << acc.getBuyEntries().front().getQuantity() - quantity << ", " << new_price << endl;
                        ...
                        out << "Ord" << order_number << ", " << client_order_id << ", " << instrument << ", " << side << ", " << "Fill" << ", " << quantity << ", " << new_price << endl;
                        out << "Ord" << acc.getBuyEntries().front().getOrderID() << ", " << acc.getBuyEntries().front().getClientOrderID() << ", " << instrument << ", " << 1 << ", " << "Fill" << ", " << quantity << ", " << new_price << endl;
                        quantity = 0;
                    }
                    else{
                        out << "Ord" << order_number << ", " << client_order_id << ", " << instrument << ", " << side << ", " << "PFill" << ", " << acc.getBuyEntries().front().getQuantity() << ", " << new_price << endl;
                        out << "Ord" << acc.getBuyEntries().front().getOrderID() << ", " << acc.getBuyEntries().front().getClientOrderID() << ", " << instrument << ", " << 1 << ", " << "Fill" << ", " << acc.getBuyEntries().front().getQuantity()<< ", " << new_price << endl;
                        acc.popFrontBuyEntries();
